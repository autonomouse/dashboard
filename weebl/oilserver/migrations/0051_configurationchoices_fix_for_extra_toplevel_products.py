...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('oilserver', '0050_make_maas_and_juju_toplevel'),
    ]
...
from crosstab(
        ...
        where
                ...
                oilserver_jujuservicedeployment.productundertest_id = oilserver_productundertest.id and
                oilserver_productundertest.producttype_id = oilserver_producttype.id and
                oilserver_producttype.toplevel = True
...
AS t(
        ...
        "juju" varchar,
        "sdn" varchar)
GROUP BY openstackversion, ubuntuversion, blockstorage, compute, database, imagestorage, juju, maas, sdn, pipeline_id

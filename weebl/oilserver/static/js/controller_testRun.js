...
app.controller('testRunController', [
    ...
    function($scope, $rootScope, $routeParams, data, DataService, Common) {
        ...
        active_filters_for_machine = {'machineconfigurations__units__jujuservicedeployment__pipeline__uuid': $scope.data.testRunId};
        ...
        {
            if(pl_testcase.testcase.testcaseclass.testframework.name == pl_testcase.build.jobtype.name)
            {
